...
<!-- Modale Prenotazione -->
<div class="modal fade" id="prenota_modal" tabindex="-1" aria-labelledby="prenota_modallabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <!-- <h5 class="modal-title" id="accedi_modallabel">Accedi</h5> -->
            ...
            <div class="modal-body bg-principal">
                <main>
                    ...
                    <div class="row" style="--bs-gutter-x: 0rem">
                        <div class="form py-5 px-5 text-center bg-principal d-flex flex-column justify-content-center">
                            <h1 class="text-light"> Prenotazioni: </h1>
                            <form action="Comandi/conferma_prenotazioni.php" method='POST'>
                                <!-- <label for="date" class="form-label">data di nascita</label> -->
                                <input type="datetime-local" class="form-control" id="datetime" value="2022-03-08" name="giorno" required>
                                <input type="range" class="form-range" id="range" min="30" max="180" step="30" value="30" name="lezione" required oninput="this.nextElementSibling.value=this.value">
                                <output>30</output>
                                <button type="submit" id="prenota" class="forma btn-light"> Conferma </button>
                            </form>
                        </div>
                    </div>
                </main>
